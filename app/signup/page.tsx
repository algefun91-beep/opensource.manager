  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-5">
      <form onSubmit={submit} className="w-full max-w-sm rounded-xl p-6"
        style={{ background: '--rounded-container-bg', border: '1px solid rgba(90,140,220,0.18)' }}>
        ...
        <button disabled={loading} className="mt-5 w-full rounded-lg py-2.5 text-sm font-medium"
          style={{ background: '--accent-blue', border: '1px solid rgba(96,165,250,0.4)', color: '#dbeafe' }}>
